...
- Resposta: Desenvolvimento de software é um conjunto de processos que tem por objetivo o desenvolvimento de um produto que realizará os objetivos pretendidos pelos interessados, "stakeholders" do projeto. 
...
A análise de requisitos é onde os desenvolvedores fazem um estudo mais aprofundado dos dados obtidos na etapa anterior. Nesta etapa começam a ser criados os modelos que possam representar uma estratégia para a solução do problema. Os desenvolvedoresse basearão nesses modelos para escrever o código.
...
A implementação consiste no desenvolvimento do código que vai resultar no sistema em desenvolvimento. 
